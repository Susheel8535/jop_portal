...
const PostJob = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-2 gap-2">
        ...
        </div>
        {
            companies.length > 0 && (
                <Select onValueChange={selectChangeHandler}>
                  <SelectTrigger className="w-[180x]">
     ...
     {
        companies.length === 0  && <p className="text-xs text-red-600 font-bold text-conter my-3">*Please register a company first, befor posting a jobs</p>
     }
        </form>
